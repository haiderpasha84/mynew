            ...
            <div class="container">
                <div class="dez-bnr-inr-entry align-m ">
					<div class="find-job-bx">
						<a href="{{route('browse.index')}}"><p class="site-button button-sm">Find Jobs, Employment & Career Opportunities</p></a>
			...
			<div class="container">
				<div class="d-flex job-title-bx section-head">
					...
					<div class="align-self-end">
						<a href="{{route('browse.index')}}" class="site-button button-sm">Browse All Jobs <i class="fa fa-long-arrow-right"></i></a>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-9">
						<ul class="post-job-bx">
							<li>
							@foreach ($jobs as $job)
								<a href="{{route('browse.show', $job->slug)}}">
									<div class="d-flex m-b30">
										<div class="job-post-company">
											<span><img src="{{asset('jobs/'.$job->slug.'.png')}}"/></span>
										</div>
									...
									<div class="d-flex">
										...
										<div class="salary-bx">
											<span>${{ $job->jsalary_min }} - $ {{ $job->jsalary_max }}</span>
										</div>
									</div>
