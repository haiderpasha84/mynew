    ...
    <div class="page-content bg-white">
        ...
        <div class="content-block">
							...
							<div class="sticky-top">
								<div class="row">
									<div class="col-lg-12 col-md-6">
										<div class="m-b30">
											<img src="{{asset('jobs/'.$job->slug.'.png')}}" alt="">
										</div>
									</div>
									<div class="col-lg-12 col-md-6">
										<div class="widget bg-white p-lr20 p-t20  widget_getintuch radius-sm">
											...
											<ul>
												...
												<li><i class="ti-money"></i><strong class="font-weight-700 text-black">Salary</strong> ${{$job->jsalary_min}} - ${{$job->jsalary_max}} Monthly </li>
			...
			<div class="section-full content-inner">
				<div class="container">
					<div class="row">
					@foreach($mightAlsoLike as $job)
						<div class="col-xl-3 col-lg-6 col-md-6">
							<div class="m-b30 blog-grid">
                                <div class="dez-post-media dez-img-effect "> <a href="{{route('browse.show', $job->slug)}}"><img src="{{asset('jobs/'.$job->slug.'.png')}}" alt=""></a> </div>
                                <div class="dez-info p-a20 border-1">
                                    <div class="dez-post-title ">
                                        <h5 class="post-title"><a href="{{route('browse.show', $job->slug)}}">{{$job->jname}}</a></h5>
                                    </div>
                                    <div class="dez-post-meta ">
                                        <ul>
                                            <li class="post-date"> <i class="ti-location-pin"></i> {{$job->jaddress}} </li>
                                            <!-- <li class="post-author"><i class="ti-user"></i>By <a href="#">Jone</a> </li> -->
                                        </ul>
                                    </div>
                                    <div class="dez-post-text">
                                         <p>
										 {{ Str::limit($job->jdescription, 30) }}
										 </p>
                                    </div>
