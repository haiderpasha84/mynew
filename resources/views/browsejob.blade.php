									...
									<h5 class="widget-title font-weight-700 text-uppercase">Category</h5>
											...
											@foreach($categories as $category)
												<ul >
													...
													<li class="{{ request()->category == $category->slug ? 'active' : '' }}"  ><a href="{{route('browse.index', ['category'=>$category->slug])}}" style="color:black;text-transform:uppercase;">{{$category->cname}}</a> </li>
